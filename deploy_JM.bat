...
echo ********************************************
echo Début de la poussée des images vers eu.GCR
echo ********************************************
...
echo ********************************************
set /p CONFIRM="Les images ont été poussées sur eu.GCR. Voulez-vous déployer les services sur Cloud Run ? (y/n) : "
if /I not "%CONFIRM%"=="y" (
